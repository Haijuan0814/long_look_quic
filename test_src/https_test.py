...
chrome_options.add_argument('--ignore-certificate-errors-spki-list=uFhDjgXmQATsyYrMvwVkfwXlnkVlB2Kz/KM6a0sZTC4=')
...
driver.get("https://10.10.1.1:8000/files/hello.txt")
